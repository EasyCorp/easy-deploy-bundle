...
abstract class AbstractConfiguration
{
    ...
    public function server(string $sshDsn, array $roles = [Server::ROLE_APP], array $properties = [], $windows = false)
    {
        ...
        $this->servers->add(new Server($sshDsn, $roles, $properties, $windows));
    }
